...
- But on trying to access the FIKLESRV01 by using crackmapexec modules but I was unsuccessful.
- I see that I can access the machine remotely.
```powershell
 proxychains xfreerdp /u:watamet /p:Nothingtoworry! /v:10.200.112.35
```
